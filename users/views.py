...
from users.service_users import generate_code, send_emails, generate_password, generate_new_user_pass
...
class RegisterView(CreateView):
    ...
    def form_valid(self, form):
        ...
        try:
            send_emails.send_verification_link(activation_url, user.email)
            user.save()
